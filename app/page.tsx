...
export default function Home() {
  const { trackWhatsAppClick, trackPhoneClick, trackEmailClick, trackScheduleClick, trackLeadFormSubmit } =
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-br from-[#f8f3f0] to-[#f0e8e3] rounded-3xl p-8 md:p-12">
              ...
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                Vamos entender juntas se a terapia comigo faz sentido para o seu momento atual e de que forma posso te
